...
dataset_name = 'All_samples_PSSMBigram.mat'
...
DF_proteins['Code'] = Dataset[:,0]
DF_proteins['Feat_vec'] = Dataset[:,1]
DF_proteins['Label'] = Dataset[:,2].astype(int)
DF_proteins['Position'] = Dataset[:,3].astype(int)
DF_proteins['Feat_mat'] = Dataset[:,4]
...
cnn_model.load_weights('Bigram_PGK_model_weights.h5')
